...
public class CityController {
    ...
    public ModelAndView home(@RequestParam(defaultValue = "en") String lg) {
        ...
        String home = messageSource.getMessage("Thành phố", null, new Locale(lg));
        String user = messageSource.getMessage("Quốc gia", null, new Locale(lg));
        String product = messageSource.getMessage("Action", null, new Locale(lg));
